        ...
        <div class="card-body p-0">
            ...
            <div class="p-3 bg-light border-bottom">
                <div class="row g-3 align-items-center">
                    <div class="col-md-6">
                        <form id="searchForm" action="{{ route('kategori.index') }}" method="GET" class="input-group">
                    ...
                    <div class="col-md-6 text-md-end">
                        <span class="text-muted">Total:
                            <strong>{{ method_exists($kategoris, 'total') ? $kategoris->total() : $kategoris->count() }}</strong>
                            kategori
                        </span>
                    </div>
                </div>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center gap-2">
                                        ...
                                        <form id="delete-form-{{ $kategori->id }}"
                                            action="{{ route('kategori.destroy', $kategori) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button type="button" class="btn btn-sm btn-danger"
                                                onclick="confirmDelete({{ $kategori->id }})" data-bs-toggle="tooltip"

        ...
        <div class="card shadow">
            ...
            <div class="card-body p-0">
                ...
                <div class="p-3 bg-light border-bottom">
                    <div class="row g-3 align-items-center">
                        <div class="col-md-6">
                            <form id="searchForm" action="{{ route('data-petugas.index') }}" method="GET"
                                class="input-group">
                        ...
                        <div class="col-md-6 text-md-end">
                            <span class="text-muted">Total:
                                <strong>{{ method_exists($petugass, 'total') ? $petugass->total() : $petugass->count() }}</strong>
                                petugas
                            </span>
                        </div>
                    </div>
                ...
                <div class="table-responsive">
                    <table class="table table-sm table-hover table-striped mb-0">
                        ...
                        <tbody>
                            @forelse($petugass as $index => $user)
                                <tr>
            ...
            <div class="card-footer bg-white py-3">
                <div class="d-flex justify-content-between align-items-center">
                    <form method="GET" action="{{ route('data-petugas.index') }}">
                    ...
                    @if (method_exists($petugass, 'links'))
                        {{ $petugass->appends(request()->query())->links() }}
                    @else

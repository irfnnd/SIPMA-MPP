                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            ...
                                            @if ($pengaduan->status != 'Selesai')
                                                <form action="{{ route('data-pengaduan.update', $pengaduan->id) }}"
                                                    method="POST" class="form-selesai" style="display: inline-block;">
                                                    @csrf
                                                    @method('PUT')
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body p-4">
                                <div class="mb-3">
                                    ...
                                    <textarea name="isi_tanggapan" id="isi_tanggapan" class="form-control" rows="5" required
                            ...
                            <div class="modal-body p-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="d-flex justify-content-between mt-2">
                                        <span
                                            class="badge {{ $pengaduan->status === 'menunggu' ? 'bg-warning text-dark' : 'bg-light text-muted' }}">Menunggu</span>
                                        <span
                                            class="badge {{ $pengaduan->status === 'diproses' ? 'bg-info' : 'bg-light text-muted' }}">Diproses</span>
                                        <span
                                            class="badge {{ $pengaduan->status === 'selesai' ? 'bg-success' : 'bg-light text-muted' }}">Selesai</span>
                                    </div>
                                </div>

...
<section id="pengaduan" class="contact section">
    <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <form action="" method="POST" enctype="multipart/form-data" class="php-email-form" data-aos="fade-up" data-aos-delay="500">
            @csrf
            <div class="row gy-4">
                ...
                <div class="col-md-12">
                    ...
                    <textarea name="isi_laporan" class="form-control" rows="5" placeholder="Tuliskan detail pengaduan Anda di sini" required></textarea>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" name="lokasi" class="form-control" placeholder="Contoh: Kantor Pelayanan A">
                </div>
